/*
  ...
  - The values [EMAIL_VERIFICATION,PASSWORD_RESET,TWO_FACTOR] on the enum `VerificationCodeType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "VerificationCodeType_new" AS ENUM ('REGISTER', 'FORGOT_PASSWORD', 'LOGIN', 'DISABLE_2FA');
